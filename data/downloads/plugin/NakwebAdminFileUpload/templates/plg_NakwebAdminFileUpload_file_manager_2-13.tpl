    ...
    <div id="contents-filemanager-right">
        <table class="now_dir">
            <tr>
                ...
                <td>
                    ...
                    <input type="file" name="upload_file" size="40" <!--{if $plg_nakweb_00002_arrErr.upload_file}-->style="background-color:<!--{$smarty.const.ERR_COLOR|h}-->"<!--{/if}--> /><a class="btn-normal" href="javascript:;" onclick="eccube.fileManager.setTreeStatus('tree_status');eccube.setModeAndSubmit('plg_nakweb_00002_upload','',''); return false;">アップロード</a>
                </td>
            </tr>
            <tr>
                <th>フォルダ作成</th>
                <td>
                    ...
                    <input type="text" name="create_file" value="" style="width:336px;<!--{if $plg_nakweb_00002_arrErr.create_file}--> background-color:<!--{$smarty.const.ERR_COLOR|h}--><!--{/if}-->"> <a class="btn-normal" href="javascript:;" onclick="eccube.fileManager.setTreeStatus('tree_status');eccube.setModeAndSubmit('plg_nakweb_00002_create','',''); return false;">作成</a>
                </td>
            </tr>
        </table>
        ...
        <table class="list">
            ...
            <!--{if !$plg_tpl_is_top_dir}-->
                <tr id="parent_dir" onclick="eccube.setValue('select_file', '<!--{$plg_nakweb_00002_tpl_parent_dir|h}-->', 'form1'); eccube.fileManager.selectFile('parent_dir', '#808080');" onDblClick="eccube.fileManager.setTreeStatus('tree_status');eccube.fileManager.toggleTreeMenu('tree'+cnt, 'rank_img'+cnt, arrTree[cnt][2]);eccube.fileManager.doubleClick(arrTree, '<!--{$plg_nakweb_00002_tpl_parent_dir|h}-->', true, '<!--{$plg_nakweb_00002_tpl_now_dir|h}-->', true)" style="">
                    <td>
            ...
            <!--{section name=cnt loop=$plg_nakweb_00002_arrFileList}-->
                ...
                <tr id="<!--{$id}-->" style="">
                   <td class="file-name" onDblClick="eccube.fileManager.setTreeStatus('tree_status');eccube.fileManager.doubleClick(arrTree, '<!--{$plg_nakweb_00002_arrFileList[cnt].file_path|h}-->', <!--{if $arrFileList[cnt].is_dir|h}-->true<!--{else}-->false<!--{/if}-->, '<!--{$plg_nakweb_00002_tpl_now_dir|h}-->', false)">
                    ...
                    <!--{if $plg_nakweb_00002_arrFileList[cnt].is_dir}-->
                        <td class="center">
                            <a href="javascript:;" onclick="eccube.setValue('tree_select_file', '<!--{$plg_nakweb_00002_arrFileList[cnt].file_path}-->', 'form1'); eccube.fileManager.selectFile('<!--{$id}-->', '#808080');eccube.setModeAndSubmit('plg_nakweb_00002_move','',''); return false;">表示</a>
                        </td>
                    <!--{else}-->
                        <td class="center">
                            <a href="javascript:;" onclick="eccube.setValue('select_file', '<!--{$plg_nakweb_00002_arrFileList[cnt].file_path}-->', 'form1'); eccube.fileManager.selectFile('<!--{$id}-->', '#808080');eccube.setModeAndSubmit('plg_nakweb_00002_view','',''); return false;">表示</a>
                        </td>
                    <!--{/if}-->
                    <!--{if $plg_nakweb_00002_arrFileList[cnt].is_dir}-->
                        <!--{* ディレクトリはダウンロード不可 *}-->
                    ...
                    <!--{else}-->
                        <td class="center">
                            <a href="javascript:;" onclick="eccube.setValue('select_file', '<!--{$plg_nakweb_00002_arrFileList[cnt].file_path|h}-->', 'form1');eccube.fileManager.selectFile('<!--{$id}-->', '#808080');eccube.fileManager.setTreeStatus('tree_status');eccube.setModeAndSubmit('plg_nakweb_00002_download','',''); return false;">ダウンロード</a>
                        </td>
                    <!--{/if}-->
                    <td class="center">
                        <a href="javascript:;" onclick="eccube.setValue('select_file', '<!--{$plg_nakweb_00002_arrFileList[cnt].file_path|h}-->', 'form1');eccube.fileManager.selectFile('<!--{$id}-->', '#808080');eccube.fileManager.setTreeStatus('tree_status');eccube.setModeAndSubmit('plg_nakweb_00002_delete','',''); return false;">削除</a>
                    </td>
                </tr>
            <!--{/section}-->
        </table>
