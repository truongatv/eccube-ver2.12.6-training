...
class LC_Page_Plugin_CheckedItems_Config extends LC_Page_Admin_Ex {
    ...
    function action() {
        ...
        default:
            ...
            $arrForm['save_count_sp'] = $plugin['free_field3'];
            break;
        }
    ...
    function lfInitParam(&$objFormParam) {
        ...
        $objFormParam->addParam('履歴保存個数(PC)', 'save_count', array('EXIST_CHECK','NUM_CHECK'));
        $objFormParam->addParam('履歴保存個数(スマートフォン)', 'save_count_sp', array('EXIST_CHECK','NUM_CHECK'));
    }
    ...
    function updateData($arrData) {
        ...
        $sqlval['free_field3'] = $arrData['save_count_sp'];
